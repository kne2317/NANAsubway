...
public class NextTrain_3 extends JFrame {
	private String nowStation;
	protected int[] subwaynumleft = { 3094, 3148, 3192, 3934, 3010, 3044, 3098, 3145 };
	protected int[] subwaynumright = { 3084, 3138, 3144, 3278, 3344, 3946, 3926, 3052 };
	...
	private void initialize() {
		...
		TrainMap.setIcon(new ImageIcon("3TrainMap1.jpg"));
		...
		num1.setForeground(new Color(255, 153, 0));
		...
		num2.setForeground(new Color(255, 153, 0));
		...
		num3.setForeground(new Color(255, 153, 0));
		...
		leftPrint1_L.setForeground(new Color(255, 153, 0));
		...
		leftPrint2_L.setForeground(new Color(255, 153, 0));
		...
		leftPrint3_L.setForeground(new Color(255, 153, 0));
		...
		rightPrint1_L.setForeground(new Color(255, 153, 0));
		...
		rightPrint2_L.setForeground(new Color(255, 153, 0));
		...
		rightPrint3_L.setForeground(new Color(255, 153, 0));
		...
		st.setForeground(new Color(255, 153, 0));
		...
		scPanel.add(scLabel);
		scLabel.setForeground(new Color(255, 153, 0));
		...
		guide_label1.setForeground(new Color(255, 153, 0));
		...
		guide_label2.setForeground(new Color(255, 153, 0));
		...
		nowStationScanner.setForeground(new Color(204, 102, 51));
		...
		arrival_tPrint1R.setForeground(new Color(255, 153, 51));
		...
		arrival_tPrint2R.setForeground(new Color(255, 153, 51));
		...
		arrival_tPrint1L.setForeground(new Color(255, 153, 51));
		...
		arrival_tPrint2L.setForeground(new Color(255, 153, 51));
		...
		JLabel left = new JLabel("\uB300\uD654\uD589");
		left.setHorizontalAlignment(SwingConstants.CENTER);
		left.setForeground(new Color(255, 153, 51));
		left.setFont(new Font("함초롬돋움", Font.PLAIN, 25));
		left.setBounds(852, 445, 247, 33);
		NextTrain.add(left);
		
		JLabel right = new JLabel("\uC624\uAE08\uD589");
		right.setHorizontalAlignment(SwingConstants.CENTER);
		right.setForeground(new Color(255, 153, 51));
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				while(true) {
					...
					if(nearLeft1<0) {
						...
						arrival_tPrint1L.setText("대화행 열차");
					...
					if(nearLeft2<0) {
						...
						leftPrint1_L.setText( subwaynumleft[l_index1] + "번 열차 " + Sub_station.station3[nearLeft1] + "역  "+ Sub_station.getsub_Condition() );
						leftPrint2_L.setText( "");
						leftPrint3_L.setText( "");
						arrival_tPrint1L.setText("대화행 열차");
					...
					if(nearLeft3<0) {
						while(true) {
							if(nearLeft1 != nearLeft2) {
								...
								leftPrint2_L.setText( subwaynumleft[l_index2] + "번 열차 " + Sub_station.station3[nearLeft2] + "역  "+ Sub_station.getsub_Condition() );
								leftPrint2_L.setText( subwaynumleft[l_index2] + "번 열차 " + Sub_station.station3[nearLeft2] + "역  "+ Sub_station.getsub_Condition() );
								leftPrint3_L.setText( "");
					...
					if(nearLeft1 != nearLeft2 && nearLeft1 != nearLeft3 && nearLeft2 != nearLeft3) {
						...
						leftPrint1_L.setText( subwaynumleft[l_index1] + "번 열차 " + Sub_station.station3[nearLeft1] + "역  "+ Sub_station.getsub_Condition() );
						leftPrint2_L.setText( subwaynumleft[l_index2] + "번 열차 " + Sub_station.station3[nearLeft2] + "역  "+ Sub_station.getsub_Condition() );
						leftPrint3_L.setText( subwaynumleft[l_index3] + "번 열차 " + Sub_station.station3[nearLeft3] + "역  "+ Sub_station.getsub_Condition() );
				...
				while(true) {
					...
					if(nearRight1>Sub_station.station3.length) {
						
						arrival_tPrint1R.setText("오금행 열차");
					...
					if(nearRight2>Sub_station.station3.length) {
						
						rightPrint1_L.setText( subwaynumright[r_index1] + "번 열차 " + Sub_station.station3[nearRight1]+ "역  " + Sub_station.getsub_Condition() );
						rightPrint2_L.setText( "" );
						rightPrint3_L.setText( "" );
					...
					if(nearRight3>Sub_station.station3.length) {
						...
						while(true) {
							if(nearRight1 != nearRight2) {
								...
								rightPrint1_L.setText( subwaynumright[r_index1] + "번 열차 " + Sub_station.station3[nearRight1]+ "역  " + Sub_station.getsub_Condition() );
								rightPrint2_L.setText( subwaynumright[r_index2] + "번 열차 " + Sub_station.station3[nearRight2]+ "역  " + Sub_station.getsub_Condition() );
								rightPrint3_L.setText( "" );
					...
					if(nearRight1 != nearRight2 && nearRight1 != nearRight3 && nearRight2 != nearRight3) {
						...
						rightPrint1_L.setText( subwaynumright[r_index1] + "번 열차 " + Sub_station.station3[nearRight1]+ "역  " + Sub_station.getsub_Condition() );
						rightPrint2_L.setText( subwaynumright[r_index2] + "번 열차 " + Sub_station.station3[nearRight2]+ "역  " + Sub_station.getsub_Condition() );
						rightPrint3_L.setText( subwaynumright[r_index3] + "번 열차 " + Sub_station.station3[nearRight3]+ "역  " + Sub_station.getsub_Condition() );
	...
	public static int Nowstation(String nowStation) { // 현재역
		int sub_ad = 0;
		for (int i = 0; i < Sub_station.station3.length; i++) {

			if (nowStation.equals(Sub_station.station3[i])) { // 입력받은 출발역의 값과 역 배열 비교하여 주소값 찾기
	...
	public int getWaitTime(int station) {
		...
		int right, left;
		 ...
		 right = Sub_station.station3.length - length; //오른쪽 거리
		 
		 left = length; //왼쪽 거리
		 
		 if(Sub_station.station3.length - length>length) { //갈 방향 고르기
